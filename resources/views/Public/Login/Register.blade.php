...
<head>
    @include('Public.Components.Metadata.Head')
    @include('Admin.Components.Scripts.Css')
    <link rel="stylesheet" href="{{ URL::asset('style.css') }}">
</head>

<body>
    @include('Public.Components.Navigations.Menu')

    <div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
        <div class="container">
            @include('Public.Components.Messages.MessageAlert')
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="{{ url('images/services/2.webp') }}" alt="" />
                </div>
