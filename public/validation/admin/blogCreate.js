...
//Muestra datos del api stau y categori
const urlCreate = ('/api/admin/blog-create');
...
document.getElementById('blogForm').addEventListener('submit', function (event) {
    ...
    //envia los datos al api store
    if (valid) {
        const formData = new FormData(this);
        const urlStore = ('/api/admin/blog-store');
